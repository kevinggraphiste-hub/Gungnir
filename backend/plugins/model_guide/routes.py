...
MODEL_DESC_FR: dict[str, str] = {
    ...
    "anthropic/claude-opus-4.6": "Opus 4.6 — contexte 1M, raisonnement superieur",
    "anthropic/claude-opus-4.7": "Opus 4.7 — dernier flagship Anthropic, contexte 1M, raisonnement de pointe",
